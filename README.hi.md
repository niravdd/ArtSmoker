...
1. **जियोमेट्री एक्सट्रैक्शन** — एक रेक्टिफ़ाइड फ़्लो ट्रांसफ़ॉर्मर (TripoSG, 1.5 बिलियन पैरामीटर, MIT-लाइसेंस्ड) साइंड डिस्टेंस फ़ील्ड (SDF) रिप्रेज़ेंटेशन का उपयोग करके एक 2D इमेज को उच्च-निष्ठा 3D मेश में बदलता है। मेश घनत्व क्वालिटी प्रीसेट के साथ स्केल करता है (उच्चतम ऑक्ट्री रेज़ोल्यूशन पर ~10 लाख फ़ेसेस तक), जिससे चेहरों और गियर पर बारीक डिटेल मिलती है।
2. **टेक्सचरिंग** — मेश को एक **टेक्सचर बैकएंड द्वारा पेंट किया जाता है जिसे आप डिप्लॉय के समय चुनते हैं**। डिफ़ॉल्ट **TRELLIS.2** (Microsoft, MIT) है — एक SLAT/वॉक्सेल-कंडीशन्ड टेक्सचरर जो 4096² एटलस पर पूर्ण PBR मटीरियल (बेस कलर + मेटैलिक-रफ़नेस + अल्फ़ा) तैयार करता है, जो सर्वश्रेष्ठ प्रोप्राइटरी टेक्सचरर्स की गुणवत्ता के बराबर होने के साथ-साथ व्यावसायिक रूप से लाइसेंस-योग्य भी रहता है।
3. **PBR आउटपुट** — टेक्सचर्ड मेश को एम्बेडेड PBR मैप्स के साथ GLB के रूप में एक्सपोर्ट किया जाता है, जो किसी भी आधुनिक इंजन में फ़िज़िकली-बेस्ड रेंडरिंग के लिए तैयार होता है।

**अपना टेक्सचरिंग बैकएंड चुनें — लाइसेंस पूरी तरह सामने रखते हुए।** Image-to-3D तीन टेक्सचरर्स सपोर्ट करता है, जिन्हें प्रति-डिप्लॉयमेंट चुना जाता है। हर एक अपना **पूरा लाइसेंस और डिपेंडेंसी ब्रेकडाउन** डिप्लॉय डायलॉग में दिखाता है — हर मॉडल जो वह खींचता है, उस मॉडल का लाइसेंस, और वह व्यावसायिक-OK है या गेटेड — और डिप्लॉय करने से पहले आपको इसे पढ़कर स्वीकार करना होता है:

| बैकएंड | लाइसेंस | व्यावसायिक उपयोग | किसके लिए सर्वश्रेष्ठ |
|--------|---------|------------------|----------------------|
...
बैकग्राउंड रिमूवल (टेक्सचरिंग से पहले का कटआउट चरण) डिफ़ॉल्ट रूप से **BiRefNet (MIT)** उपयोग करता है — पूरी तरह व्यावसायिक-क्लीन — और एक गैर-व्यावसायिक विकल्प (RMBG) एक प्रकट किए गए ऑप्ट-इन के रूप में उपलब्ध है। ArtSmoker कभी भी चुपचाप कोई प्रतिबंधित डिपेंडेंसी नहीं खींचता: जो कुछ भी गेटेड या गैर-व्यावसायिक है उसे नाम दिया जाता है, बैज लगाया जाता है, और एक स्पष्ट स्वीकृति के पीछे गेट किया जाता है।

**आउटपुट:** एम्बेडेड PBR टेक्सचर के साथ मानक GLB — Unity, Unreal Engine, Blender और अन्य गेम इंजन में सीधे इम्पोर्ट होता है। इंटरैक्टिव 3D व्यूअर तत्काल निरीक्षण के लिए ऑर्बिट, ज़ूम और पैन सपोर्ट करता है, और **3D Model** टैब प्रत्येक एसेट को बनाने में उपयोग किए गए सटीक मॉडल और टूल्स (जियोमेट्री मॉडल, टेक्सचरिंग बैकएंड, डिपेंडेंसीज़, इंस्टेंस, पैरामीटर) पूर्ण प्रोवेनेंस के लिए सूचीबद्ध करता है।

**इंफ़्रास्ट्रक्चर:** समान वन-क्लिक Custom Models फ़्लो से डिप्लॉय होता है, जहाँ डिप्लॉय-समय का बैकएंड पिकर प्रत्येक विकल्प का लाइसेंस, डिपेंडेंसी टेबल, इंस्टेंस बेसलाइन, और अनुमानित लागत/समय दिखाता है। `ml.g6e` GPU इंस्टेंस पर चलता है; निष्क्रिय होने पर शून्य तक स्केल — जॉब्स के बीच $0 लागत। पहला कोल्ड स्टार्ट CUDA एक्सटेंशन्स को एक बार बिल्ड करता है (फिर तेज़ रीस्टार्ट के लिए S3-कैश्ड)।
