...
1. **जियोमेट्री एक्सट्रैक्शन** — एक रेक्टिफ़ाइड फ़्लो ट्रांसफ़ॉर्मर (TripoSG, 1.5 बिलियन पैरामीटर) SDF (साइंड डिस्टेंस फ़ील्ड) रिप्रेज़ेंटेशन का उपयोग करके एक 2D इमेज को उच्च-निष्ठा 3D मेश में बदलता है
2. **मल्टी-व्यू सिंथेसिस** — एक व्यावसायिक रूप से लाइसेंस-योग्य मल्टी-व्यू डिफ्यूज़न बैकएंड (MVPainter, Apache-2.0) मेश की नॉर्मल और डेप्थ मैप्स पर आधारित सोर्स इमेज से 6 सुसंगत व्यू जनरेट करता है
3. **टेक्सचर बेकिंग** — मल्टी-व्यू इमेज UV अनरैपिंग, सीम इनपेंटिंग और वैकल्पिक अपस्केलिंग के साथ मेश पर प्रोजेक्ट की जाती हैं, जिससे पूरी तरह टेक्सचर्ड GLB बनता है

**आउटपुट:** एम्बेडेड टेक्सचर के साथ मानक GLB फ़ॉर्मेट — Unity, Unreal Engine, Blender और अन्य गेम इंजन में सीधे इम्पोर्ट होता है। ArtSmoker का इंटरैक्टिव 3D व्यूअर तत्काल निरीक्षण के लिए ऑर्बिट, ज़ूम और पैन सपोर्ट करता है।

**इंफ़्रास्ट्रक्चर:** समान वन-क्लिक Custom Models फ़्लो से डिप्लॉय करें। `ml.g5.2xlarge` (24 GB, $1.51/घंटा) पर अनुक्रमिक मॉडल लोडिंग, या `ml.g6e` (48 GB) पर सभी मॉडल एक साथ लोड। निष्क्रिय होने पर शून्य तक स्केल — जॉब्स के बीच $0 लागत।

| मेट्रिक | मान |
|---------|-----|
| जनरेशन समय | प्रति एसेट 60-90 सेकंड |
| मेश गुणवत्ता | 2 लाख-4.5 लाख फ़ेसेस, पूर्ण वर्टेक्स नॉर्मल्स |
| टेक्सचर रेज़ोल्यूशन | 4K UV एटलस तक |
