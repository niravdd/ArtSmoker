    ...
    window.ImageStudio = {
        ...
        render() {
            return html`
                <div id="generator-view" class="view-enter">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold">${t('artsmoker.ui.image_studio.title')}</h1>
                        <p class="text-brand-text-muted text-sm mt-1">${t('artsmoker.ui.image_studio.subtitle')}</p>
                    </div>
                        ...
                        <aside class="lg:w-72 xl:w-80 flex-shrink-0 space-y-5">
                            <div class="card-static p-5 space-y-5">
                                <h2 class="text-lg font-semibold flex items-center gap-2">
                                    ...
                                    ${t('artsmoker.ui.common.settings')}
                                </h2>

                                <div>
                                    <label class="block text-sm font-medium mb-1.5">${t('artsmoker.ui.image_studio.style')}</label>
                                    <div class="select-expand-wrap">
                                        <select id="gen-style" class="input">
                                            <option value="">${t('artsmoker.ui.image_studio.style_none')}</option>
                                        </select>
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium mb-1.5">${t('artsmoker.ui.image_studio.asset_type')}</label>
                                    <div class="select-expand-wrap">
                                ...
                                <div>
                                    <label class="block text-sm font-medium mb-1.5">${t('artsmoker.ui.image_studio.model')}</label>
                                    <div id="gen-model-multi" class="relative">
                                        <button id="gen-model-btn" type="button" class="input text-left flex items-center justify-between w-full cursor-pointer">
                                            <span id="gen-model-label" class="truncate text-sm">${t('artsmoker.ui.image_studio.select_models')}</span>
                                    ...
                                    <div id="gen-all-models-opts" class="hidden mt-2 p-2 rounded-lg bg-brand-bg/50 space-y-1.5">
                                        <label class="flex items-center gap-2 text-xs text-brand-text-muted cursor-pointer">
                                            ...
                                            ${t('artsmoker.ui.image_studio.model_optimized_prompts')}
                                        </label>
                                        <p class="text-[10px] text-brand-text-dim">${t('artsmoker.ui.image_studio.model_optimized_desc')}</p>
                                ...
                                <details id="gen-advanced-section" class="group">
                                    <summary class="text-xs font-medium text-brand-text-muted cursor-pointer hover:text-brand-text transition-colors select-none">
                                        <span class="group-open:hidden">\u25B8 ${t('artsmoker.ui.image_studio.advanced_expand')}</span>
                                        <span class="hidden group-open:inline">\u25BE ${t('artsmoker.ui.image_studio.advanced_collapse')}</span>
                                    </summary>
                                    <div class="mt-2 space-y-3 p-2.5 rounded-lg bg-brand-bg/40 border border-brand-border/50">
                                        <div>
                                            <label class="block text-[10px] text-brand-text-muted uppercase tracking-wider mb-1">${t('artsmoker.ui.image_studio.quality')}</label>
                                            <select id="gen-quality" class="input text-xs">
                                                <option value="">${t('artsmoker.ui.common.default')}</option>
                                            </select>
                                        </div>
                                        <div>
                                            <label class="block text-[10px] text-brand-text-muted uppercase tracking-wider mb-1">${t('artsmoker.ui.image_studio.region')}</label>
                                            <select id="gen-region" class="input text-xs">
                                                <option value="">${t('artsmoker.ui.image_studio.region_auto')}</option>
                                            </select>
                                        </div>
                                    </div>
                                </details>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[10px] text-brand-text-muted mt-0.5">${t('artsmoker.ui.image_studio.per_option')}</p>
                                    </div>
                                </div>
                            ...
                            <div class="card-static p-4 space-y-3">
                                <h2 class="text-sm font-semibold flex items-center gap-2 text-brand-text-muted uppercase tracking-wide">
                                    ...
                                    ${t('artsmoker.ui.image_studio.ip_declaration')}
                                </h2>
                                <div class="space-y-2">
                                    <label class="flex items-start gap-2 cursor-pointer">
                                        ...
                                        <span class="text-xs text-brand-text/80">${t('artsmoker.ui.image_studio.ip_own')}</span>
                                    </label>
                                    <label class="flex items-start gap-2 cursor-pointer">
                                        ...
                                        <span class="text-xs text-brand-text/80">${t('artsmoker.ui.image_studio.ip_license')}</span>
                                    </label>
                                </div>
                                ...
                                <p class="text-[10px] text-brand-text-muted/50">${t('artsmoker.ui.image_studio.ip_help')}</p>
                                ...
                                <div class="flex items-center justify-between pt-2 border-t border-brand-border/30">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <label class="text-xs font-medium">${t('artsmoker.ui.image_studio.pre_check_label')}</label>
                                    </div>
                                    <label class="toggle"><input type="checkbox" id="gen-precheck" checked><span class="toggle-slider"></span></label>
                                </div>
                                <p class="text-[10px] text-brand-text-muted/50 -mt-1">${t('artsmoker.ui.image_studio.pre_check_help')}</p>
                            </div>
                            ...
                            <button id="btn-model-settings" class="w-full text-left p-3 rounded-lg bg-emerald-700 hover:bg-emerald-600 border border-emerald-500/30 transition-colors flex items-center gap-2 text-xs text-white font-medium">
                                ...
                                ${t('artsmoker.ui.image_studio.model_settings')}
                            </button>
                            ...
                            <div class="card-static p-5 space-y-4">
                                <h2 class="text-sm font-semibold flex items-center gap-2 text-brand-text-muted uppercase tracking-wide">
                                    ...
                                    <span id="gen-processing-label">${t('artsmoker.ui.image_studio.post_processing')}</span>
                                </h2>
                                <div class="space-y-3">
                                    <div class="flex items-center justify-between">
                                        <label class="text-sm">${t('artsmoker.ui.image_studio.remove_bg')}</label>
                                        <label class="toggle"><input type="checkbox" id="gen-remove-bg"><span class="toggle-slider"></span></label>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <label class="text-sm">${t('artsmoker.ui.image_studio.convert_svg')}</label>
                                        <label class="toggle"><input type="checkbox" id="gen-svg" checked><span class="toggle-slider"></span></label>
                                    </div>
                                    <div class="flex items-center justify-between">
                                        <label class="text-sm">${t('artsmoker.ui.image_studio.upscale')}</label>
                                ...
                                <button id="btn-apply-postprocess" class="btn btn-secondary btn-sm w-full hidden">
                                    ...
                                    ${t('artsmoker.ui.image_studio.pp_apply')}
                                </button>
                                <p id="pp-hint" class="text-[10px] text-brand-text-muted/50 hidden">${t('artsmoker.ui.image_studio.pp_hint')}</p>
                            </div>

                            <p class="artsmoker-version text-[9px] text-brand-text-dim/30 text-center mt-4">${t('artsmoker.ui.app.version_prefix')}</p>
                        </aside>
                        ...
                        <div class="flex-1 min-w-0 space-y-5">
                            ...
                            <div class="card-static p-5 space-y-4">
                                <div class="flex items-center gap-1.5 p-1 rounded-xl bg-brand-bg/60 border border-brand-border -mt-1">
                                    <button id="tab-prompt" data-tab="prompt" class="is-tab flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg transition-all bg-cyan-500 text-white shadow-sm">
                                        ...
                                        ${t('artsmoker.ui.image_studio.tab_text_inspiration')}
                                    </button>
                                    <button id="tab-reference" data-tab="reference" class="is-tab flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-semibold rounded-lg transition-all bg-cyan-500/15 text-cyan-300/80 hover:bg-cyan-500/25 hover:text-cyan-200">
                                        ...
                                        ${t('artsmoker.ui.image_studio.reference_tab')}
                                    </button>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-3 mt-2">
                                ...
                                <button id="btn-reset" class="btn btn-lg text-base bg-amber-600 hover:bg-amber-500 text-white">
                                    ...
                                    ${t('artsmoker.ui.image_studio.reset')}
                                </button>
                            </div>
                            ...
                            <button id="btn-pending-jobs" class="w-full text-left p-2 rounded-lg bg-cyan-700/10 border border-cyan-600/20 hover:border-cyan-500/40 hover:bg-cyan-700/20 transition-colors flex items-center gap-2 text-xs text-cyan-400 mt-2 hidden">
                                ...
                                <span id="pending-jobs-label">${t('artsmoker.ui.custom_models.pending_jobs')}</span>
                            </button>
                            ...
                            <div id="gen-prompt-info" class="hidden card-static p-4 space-y-3">
                                <div id="gen-original-prompt-section">
                                    <p class="text-[10px] text-brand-text-muted uppercase tracking-wider font-semibold mb-1">${t('artsmoker.ui.image_studio.original_prompt_label')}</p>
                                    <p id="gen-original-prompt-text" class="text-sm text-brand-text/80 leading-relaxed"></p>
                                </div>
                                <div id="gen-used-prompt-section">
                                    <p class="text-[10px] text-brand-text-muted uppercase tracking-wider font-semibold mb-1">${t('artsmoker.ui.image_studio.enhanced_prompt_label')}</p>
                                ...
                                <div id="gen-negative-prompt-section" class="hidden">
                                    <p class="text-[10px] text-amber-400/80 uppercase tracking-wider font-semibold mb-1">${t('artsmoker.ui.image_studio.negative_prompt_exclusions')}</p>
                                ...
                                <div id="gen-cost-breakdown" class="hidden p-3 rounded-lg bg-emerald-950/20 border border-emerald-500/20">
                                    <div class="flex items-center justify-between mb-1">
                                        <span class="text-[10px] text-emerald-400/80 uppercase tracking-wider font-semibold">${t('artsmoker.ui.image_studio.est_cost')}</span>
                                ...
                                <div id="gen-rewrite-disclaimer" class="hidden p-3 rounded-lg bg-amber-950/20 border border-amber-500/20">
                                    <p class="text-[10px] text-amber-300/80"><strong>${t('artsmoker.ui.image_studio.rewritten_prompt_note')}</strong> ${t('artsmoker.ui.image_studio.rewrite_disclaimer_text')}</p>
                                </div>
                            </div>

                            <!-- Concept prompt display -->
                            <div id="gen-concept-prompt" class="hidden card-static p-3 space-y-2">
                                <p id="gen-concept-prompt-label" class="text-[10px] text-brand-text-muted uppercase tracking-wider font-semibold">${t('artsmoker.ui.image_studio.generated_prompt')}</p>
                                <p id="gen-concept-prompt-text" class="text-xs text-brand-text/70 leading-relaxed"></p>
                                <div id="gen-concept-negative" class="hidden">
                                    <p class="text-[10px] text-amber-400/80 uppercase tracking-wider font-semibold mb-0.5">${t('artsmoker.ui.image_studio.negative_prompt_label')}</p>
                            ...
                            <div class="card-static overflow-hidden">
                                <div id="gen-preview" class="preview-checkerboard min-h-[350px] lg:min-h-[450px] flex items-center justify-center p-6 relative">
                                    <div id="gen-placeholder" class="text-center">
                                        ...
                                        <p class="text-brand-text-muted/40 text-sm">${t('artsmoker.ui.image_studio.placeholder_text')}</p>
                                    </div>
                                    <div id="gen-loading" class="hidden absolute inset-0 bg-brand-bg/60 flex flex-col items-center justify-center gap-4 px-8">
                                        ...
                                        <p id="gen-loading-text" class="text-sm text-brand-text-muted font-medium">${t('artsmoker.ui.image_studio.generating')}</p>
        ...
        async init() {
            ...
            document.getElementById('btn-reset')?.addEventListener('click', async () => {
                if (this._result && !await window.showConfirm(t('artsmoker.ui.image_studio.reset_confirm'), { title: t('artsmoker.ui.image_studio.reset'), detail: t('artsmoker.ui.image_studio.reset_detail'), confirmLabel: t('artsmoker.ui.image_studio.reset'), danger: true })) return;
        ...
        async _loadModels(regionFilter) {
            ...
            sep.innerHTML = html`<label class="flex items-center gap-2 text-xs cursor-pointer py-1 hover:bg-brand-bg/60 rounded px-1">
                ...
                <span class="text-brand-text-muted">\u2500\u2500 ${t('artsmoker.ui.image_studio.all_models') || 'All Available Models'}</span>
            </label>`;
        ...
        _updateQualityForModel(modelKey) {
            ...
            if (!qualSel || modelKey === 'all_models') {
                // nosemgrep
                if (qualSel) { qualSel.innerHTML = html`<option value="">${t('artsmoker.ui.image_studio.quality_default')}</option>`; }
                return;
            }
            ...
            if (options.length === 0) {
                ...
                opt.value = '';
                opt.textContent = t('artsmoker.ui.image_studio.quality_default_no_tiers');
                qualSel.appendChild(opt);
            } else {
                options.forEach(q => {
                    const opt = document.createElement('option');
                    opt.value = q.value;
                    opt.textContent = q.value === defaultQ ? `${q.label} (${t('artsmoker.ui.common.default')})` : q.label;
        ...
        _updateModelSummary() {
            ...
            if (costEl && price != null) {
                ...
                costEl.textContent = t('artsmoker.ui.image_studio.est_cost_line').replace('{{est}}', est).replace('{{total}}', total).replace('{{price}}', price.toFixed(2));
            } else if (costEl) {
                costEl.textContent = '';
            }
        },
        ...
        _updateRegionForModel(modelKey) {
            ...
            if (regions.length <= 1) {
                ...
                auto.textContent = cheapest.price_usd != null
                    ? `${t('artsmoker.ui.image_studio.region_auto')} \u2014 ${cheapest.region} ($${cheapest.price_usd.toFixed(2)}/img)`
                    : `${t('artsmoker.ui.image_studio.region_auto')} \u2014 ${cheapest.region}`;
                regionSel.appendChild(auto);
                regions.forEach(rp => {
                    const opt = document.createElement('option');
                    opt.value = rp.region;
        ...
        _populateRegions(regions) {
            ...
            const current = regionSel.value;
            // nosemgrep
            regionSel.innerHTML = html`<option value="">${t('artsmoker.ui.image_studio.region_all')}</option>`;
            (regions || []).forEach(r => {
                const opt = document.createElement('option');
                opt.value = r;
                opt.textContent = r;
        ...
        async _handleGenerate() {
            ...
            if (unsupportedModels.length > 0 && window.showConfirm) {
                ...
                const shouldContinue = await window.showConfirm(
                    `${modelNames} ${unsupportedModels.length === 1 ? 'does' : 'do'} not support ${size.label}. The closest supported size will be used for ${unsupportedModels.length === 1 ? 'this model' : 'these models'}.`,
                    {
                        ...
                        cancelLabel: t('artsmoker.ui.image_studio.change_dimensions'),
                    }
                );
            ...
            if (!this._selectedModels.length && !isReference) {
                window.showToast?.(t('artsmoker.ui.image_studio.select_at_least_one_model') || 'Select at least one model', 'error');
                return;
            }
            ...
            if (btn) {
                btn.disabled = true;
                // nosemgrep
                btn.innerHTML = html`<span class="spinner-sm"></span> ${t('artsmoker.ui.image_studio.checking')}`;
            }
                    ...
                    if (classifyResp.ok) {
                        ...
                        if (assetCheck.mismatch) {
                            ...
                            const shouldSwitch = await window.showConfirm(
                                assetCheck.reason,
                                {
                                    title: t('artsmoker.ui.image_studio.asset_type_wrong_title'),
                                    detail: t('artsmoker.ui.image_studio.asset_type_wrong_detail').replace('{{cur}}', curLabel).replace('{{sug}}', sugLabel),
            ...
            if (preCheckOn) {
                try {
                    window.showLoading?.(t('artsmoker.ui.image_studio.pre_checking'));
            ...
            if (selectedModelInfo?.model_source === 'custom_hosted') {
                ...
                if (sub) sub.textContent = t('artsmoker.ui.custom_models.cold_start_warning');
            }
            ...
            try {
                const result = await API.generateStream(payload, (evt) => {
                    ...
                    if (evt.type === 'prompt_refused') {
                        promptRefused = true;
                        refusalReason = evt.reason || evt.message || t('artsmoker.ui.image_studio.prompt_declined');
                    }
                ...
                // All Models mode — partial results are valid
                    ...
                    if (blocked.length > 0 || failed.length > 0) {
                        const parts = [t('artsmoker.ui.image_studio.models_generated').replace('{{succeeded}}', succeeded).replace('{{total}}', totalModels)];
                        if (blocked.length > 0) {
                            const names = blocked.map(o => o.model_label || t('artsmoker.ui.common.unknown')).join(', ');
                            parts.push(t('artsmoker.ui.image_studio.models_blocked').replace('{{count}}', blocked.length).replace('{{names}}', names));
                        }
                        if (failed.length > 0) parts.push(t('artsmoker.ui.image_studio.models_failed').replace('{{count}}', failed.length));
                        window.showToast?.(parts.join('. ') + '.', succeeded > 0 ? 'warning' : 'error', 8000);
                    } else {
                        window.showToast?.(t('artsmoker.ui.image_studio.all_models_success').replace('{{count}}', totalModels), 'success');
                    }
                }
                // Single-model moderation block
                else if (moderationBlocked || (totalGenerated === 0 && this._moderationErrors.length > 0)) {
                    this._result = null;
                    this._showModerationDialog(prompt, this._moderationErrors[0] || t('artsmoker.ui.image_studio.moderation_blocked'), payload);
                } else if (totalGenerated === 0) {
                    window.showToast?.(t('artsmoker.ui.image_studio.all_failed'), 'error');
                } else {
                    ...
                    if (blocked > 0) {
                        window.showToast?.(
                            t('artsmoker.ui.image_studio.images_partial').replace('{{generated}}', totalGenerated).replace('{{total}}', totalGenerated + blocked).replace('{{blocked}}', blocked) + costStr,
                            'warning', 10000
                        );
                    } else {
                        window.showToast?.(t('artsmoker.ui.image_studio.images_generated').replace('{{count}}', totalGenerated).replace('{{options}}', (result.options || []).length) + costStr, 'success');
                    }
                ...
                if (this._moderationErrors.length > 0 || moderationBlocked) {
                    this._showModerationDialog(prompt, this._moderationErrors[0] || t('artsmoker.ui.image_studio.generation_failed'), payload);
                } else {
                    window.showToast?.(err.message || t('artsmoker.ui.image_studio.generation_failed'), 'error');
                }
            } finally {
        ...
        async _handlePostProcess() {
            if (!this._result) {
                window.showToast?.(t('artsmoker.ui.image_studio.generate_first'), 'warning');
                return;
            }
            ...
            if (assetIds.length === 0) {
                window.showToast?.(t('artsmoker.ui.image_studio.no_images_process'), 'warning');
                return;
            }
            ...
            // nosemgrep
            btn.innerHTML = html`<span class="spinner-sm"></span> ${t('artsmoker.ui.image_studio.processing_btn')}`;
            btn.disabled = true;
            ...
            try {
                ...
                window.showToast?.(t('artsmoker.ui.image_studio.pp_applied').replace('{{count}}', count).replace('{{plural}}', count !== 1 ? 's' : ''), 'success');
            ...
            dialog.innerHTML = html`
                <div class="bg-brand-surface rounded-xl border border-brand-border shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 border-b border-brand-border bg-amber-950/30">
                        ...
                        <h2 class="text-lg font-semibold text-amber-300">${t('artsmoker.ui.image_studio.content_moderation_issue')}</h2>
                    ...
                    <div class="flex-1 overflow-auto p-6" id="mod-content">
                        <div class="flex flex-col items-center justify-center py-8 gap-3 text-brand-text-muted">
                            ...
                            <p>${t('artsmoker.ui.image_studio.testing_alternative')}</p>
                            <p class="text-[10px] text-brand-text-muted/50">${t('artsmoker.ui.image_studio.alternative_hint')}</p>
                        </div>
                    </div>
                </div>
            `;
            ...
            try {
                ...
                if (action === 'switch_model') {
                        ...
                        <div class="space-y-5">
                            <div class="p-4 rounded-lg bg-emerald-950/30 border border-emerald-500/20">
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <span class="text-sm font-semibold text-emerald-300">${t('artsmoker.ui.image_studio.prompt_works_with').replace('{{model}}', workingModelLabel)}</span>
                                </div>
                            ...
                            <div class="p-3 rounded-lg bg-brand-accent/10 border border-brand-accent/20 text-xs text-brand-text/80">
                                <strong>${t('artsmoker.ui.image_studio.ip_declaration_noted')}</strong>
                                ${ipOwned ? ' ' + t('artsmoker.ui.image_studio.ip_own_noted') : ''}${ipLicensed ? ' ' + t('artsmoker.ui.image_studio.ip_license_noted') : ''}
                                <br>${t('artsmoker.ui.image_studio.ip_moderation_note').replace('{{model}}', originalModelLabel)}
                            </div>` : ''}

                            <p class="text-xs text-brand-text-muted">${!hasIpClaim ? t('artsmoker.ui.image_studio.prompt_preserved_game') : t('artsmoker.ui.image_studio.prompt_preserved')}</p>

                            ${!hasIpClaim ? html`
                            <div class="p-3 rounded-lg bg-brand-bg/40 border border-brand-border space-y-2">
                                <p class="text-[10px] text-brand-text-muted font-medium">${t('artsmoker.ui.image_studio.ip_reference_hint')}</p>
                            ...
                            <div class="flex gap-3 pt-2">
                                <button id="mod-switch-model" class="btn bg-emerald-600 hover:bg-emerald-500 text-white flex-1">
                                    ...
                                    ${t('artsmoker.ui.image_studio.generate_with').replace('{{model}}', workingModelLabel)}
                                </button>
                                <button id="mod-rewrite-instead" class="btn btn-secondary btn-sm">
                                    ${t('artsmoker.ui.image_studio.rewrite_for').replace('{{model}}', originalModelLabel)}
                                </button>
                            </div>

                            <details class="text-xs">
                                <summary class="text-brand-text-muted cursor-pointer hover:text-brand-text">${t('artsmoker.ui.image_studio.view_model_tests').replace('{{count}}', (analysis.attempts || []).length)}</summary>
                    ...
                    document.getElementById('mod-rewrite-instead')?.addEventListener('click', async () => {
                        ...
                        if (content) {
                            ...
                            content.innerHTML = html`<div class="flex flex-col items-center justify-center py-8 gap-3 text-brand-text-muted">
                                <div class="loading-spinner w-5 h-5 border-2 border-brand-accent/20 border-t-brand-accent rounded-full"></div>
                                <p>${t('artsmoker.ui.image_studio.attempting_rewrite').replace('{{model}}', originalModelLabel)}</p>
                                <p class="text-[10px] text-brand-text-muted/50">${t('artsmoker.ui.image_studio.canary_hint')}</p>
                            </div>`;
                        }
                        try {
                            ...
                            if (rewriteResult.rewritten_prompt) {
                                const verifiedBadge = rewriteResult.verified
                                    ? html`<span class="text-[10px] font-medium text-emerald-400 bg-emerald-400/10 px-2 py-0.5 rounded-full">${t('artsmoker.ui.image_studio.passed_canary')}</span>`
                                    : html`<span class="text-[10px] font-medium text-amber-400 bg-amber-400/10 px-2 py-0.5 rounded-full">${t('artsmoker.ui.image_studio.not_verified')}</span>`;
                                const content = document.getElementById('mod-content');
                                if (content) {
                                    // nosemgrep
                                    content.innerHTML = html`<div class="space-y-4">
                                        <div>
                                            <h3 class="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-2 flex items-center gap-2">
                                                ${t('artsmoker.ui.image_studio.rewritten_for').replace('{{model}}', originalModelLabel)} ${verifiedBadge}
                                            </h3>
                                        ...
                                        <div class="p-3 rounded-lg bg-amber-950/20 border border-amber-500/20">
                                            <p class="text-[10px] text-amber-300/80"><strong>${t('artsmoker.ui.image_studio.best_effort_rewrite')}</strong> ${t('artsmoker.ui.image_studio.rewrite_disclaimer').replace('{{model}}', originalModelLabel)}</p>
                                        </div>
                                        <div class="flex gap-3 pt-2">
                                            <button id="mod-accept-inline-rewrite" class="btn btn-primary flex-1">${t('artsmoker.ui.image_studio.use_rewrite_review')}</button>
                                            <button class="mod-close-btn btn btn-secondary">${t('artsmoker.ui.common.cancel')}</button>
                                        </div>
                                    </div>`;
                                ...
                                dialog.remove();
                                window.showToast?.(t('artsmoker.ui.image_studio.could_not_rewrite').replace('{{model}}', originalModelLabel), 'warning');
                            }
                        } catch (err) {
                            dialog.remove();
                            window.showToast?.(t('artsmoker.ui.image_studio.rewrite_failed') + ': ' + (err.message || ''), 'error');
                        }
                    });
                    ...
                    const verifiedBadge = verified
                        ? html`<span class="inline-flex items-center gap-1 text-xs font-medium text-emerald-400 bg-emerald-400/10 px-2 py-0.5 rounded-full">${t('artsmoker.ui.image_studio.verified_passed')}</span>`
                        : html`<span class="inline-flex items-center gap-1 text-xs font-medium text-red-400 bg-red-400/10 px-2 py-0.5 rounded-full">${t('artsmoker.ui.image_studio.not_verified_may_reject')}</span>`;

                    // nosemgrep
                    content.innerHTML = html`
                        <div class="space-y-5">
                            <div>
                                <p class="text-sm text-brand-text/90 leading-relaxed">${analysis.explanation || t('artsmoker.ui.image_studio.all_models_rejected')}</p>
                                <p class="text-xs text-brand-text-muted mt-1">${t('artsmoker.ui.image_studio.attempts_tested').replace('{{count}}', (analysis.attempts || []).length)}</p>
                        </div>

                        ${(analysis.issues || []).length > 0 ? html`
                        <div>
                            <h3 class="text-xs font-semibold text-amber-400 uppercase tracking-wider mb-2">${t('artsmoker.ui.image_studio.issues_detected')}</h3>
                        ...
                        <div>
                            <h3 class="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-2 flex items-center gap-2">
                                ${t('artsmoker.ui.image_studio.recommended_rewrite')} ${verifiedBadge}
                            </h3>
                            <textarea id="mod-rewritten-prompt" class="input w-full min-h-[120px] text-sm">${analysis.rewritten_prompt || ''}</textarea>
                            <p class="text-[10px] text-brand-text-muted mt-1">${verified ? t('artsmoker.ui.image_studio.rewrite_verified_note') : t('artsmoker.ui.image_studio.rewrite_not_verified_note')} ${t('artsmoker.ui.image_studio.review_edit_note')}</p>
                        </div>

                        <div>
                            <details class="text-xs">
                                <summary class="text-brand-text-muted cursor-pointer hover:text-brand-text">${t('artsmoker.ui.image_studio.view_original_prompt')}</summary>
                        ...
                        <div>
                            <details class="text-xs">
                                <summary class="text-brand-text-muted cursor-pointer hover:text-brand-text">${t('artsmoker.ui.image_studio.view_rewrite_attempts').replace('{{count}}', analysis.attempts.length)}</summary>
                                <div class="mt-2 space-y-2">
                                    ${(analysis.attempts || []).map((a, i) => html`
                                        <div class="p-2 rounded-lg bg-brand-bg/40 border border-brand-border">
                                            <div class="flex items-center gap-2 mb-1">
                                                <span class="text-[10px] font-bold">${t('artsmoker.ui.image_studio.attempt_label').replace('{{num}}', a.attempt)}</span>
                        ...
                        <div class="flex gap-3 pt-2">
                            <button id="mod-use-rewrite" class="btn btn-primary flex-1">
                                ...
                                ${t('artsmoker.ui.image_studio.review_rewritten_prompt')}
                            </button>
                            <button id="mod-dismiss" class="btn btn-secondary">
                                ${t('artsmoker.ui.image_studio.edit_manually')}
                            </button>
                        </div>
                    </div>
                `;
                ...
                if (content) {
                    ...
                    content.innerHTML = html`
                        <div class="text-center py-8">
                            <p class="text-red-400 mb-2">${t('artsmoker.ui.image_studio.analyze_failed')}</p>
                            <p class="text-sm text-brand-text-muted">${t('artsmoker.ui.image_studio.analyze_failed_hint')}</p>
                            <button class="mod-close-btn btn btn-secondary btn-sm mt-4">${t('artsmoker.ui.common.close')}</button>
                        </div>
                    `;
                    content.querySelector('.mod-close-btn')?.addEventListener('click', () => dialog.remove());
                }
            ...
            dialog.innerHTML = html`
                <div class="bg-brand-surface rounded-xl border border-brand-border shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 border-b border-brand-border bg-red-950/30">
                        ...
                        <h2 class="text-lg font-semibold text-red-300">${t('artsmoker.ui.image_studio.prompt_cannot_be_processed')}</h2>
                        <button class="mod-close ml-auto p-2 rounded-lg hover:bg-white/5 text-brand-text-muted hover:text-brand-text">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                    ...
                    <div class="flex-1 overflow-auto p-6 space-y-4">
                        <p class="text-sm text-brand-text/90 leading-relaxed">${t('artsmoker.ui.image_studio.prompt_declined_reason')}</p>
                        <ul class="space-y-1 text-sm text-brand-text-muted">
                            <li class="flex items-start gap-2"><span class="text-red-400 mt-0.5">•</span> ${t('artsmoker.ui.image_studio.decline_likeness')}</li>
                            <li class="flex items-start gap-2"><span class="text-red-400 mt-0.5">•</span> ${t('artsmoker.ui.image_studio.decline_misinfo')}</li>
                            <li class="flex items-start gap-2"><span class="text-red-400 mt-0.5">•</span> ${t('artsmoker.ui.image_studio.decline_harmful')}</li>
                        </ul>
                        <div class="p-3 rounded-lg bg-brand-bg/60 text-xs text-brand-text-muted">
                            <p class="font-medium mb-1">${t('artsmoker.ui.image_studio.ai_response')}</p>
                            <p class="whitespace-pre-wrap">${reason.substring(0, 500)}</p>
                        </div>
                        <p class="text-xs text-brand-text-muted">${t('artsmoker.ui.image_studio.decline_note')}</p>
                        <div class="flex gap-3 pt-2">
                            <button class="mod-close-btn btn btn-secondary flex-1">${t('artsmoker.ui.image_studio.edit_prompt_btn')}</button>
                        </div>
                    </div>
                </div>
            `;
        ...
        _showPreCheckDialog(originalPrompt, screen, payload) {
            ...
            dialog.innerHTML = html`
                <div class="bg-brand-surface rounded-xl border border-brand-border shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden">
                    <div class="flex items-center gap-3 px-6 py-4 border-b border-brand-border bg-brand-accent/10">
                        ...
                        <h2 class="text-lg font-semibold">${t('artsmoker.ui.image_studio.pre_check_title')}</h2>
                        <button class="mod-close ml-auto p-2 rounded-lg hover:bg-white/5 text-brand-text-muted hover:text-brand-text">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                    ...
                    <div class="flex-1 overflow-auto p-6 space-y-5">
                        ...
                        <div>
                            <h3 class="text-xs font-semibold text-amber-400 uppercase tracking-wider mb-2">${t('artsmoker.ui.image_studio.potential_issues')}</h3>
                            <ul class="space-y-1">
                        ...
                        ${suggested ? html`
                        <div class="p-4 rounded-lg bg-emerald-950/30 border border-emerald-500/20">
                            <p class="text-sm text-emerald-300 font-medium mb-1">${t('artsmoker.ui.image_studio.recommended_switch').replace('{{model}}', suggestedLabel)}</p>
                            <p class="text-xs text-brand-text-muted">${t('artsmoker.ui.image_studio.prompt_works_as_is')}</p>
                        </div>` : ''}
                        ...
                        <div class="flex flex-wrap gap-3 pt-2">
                            ...
                            <button id="precheck-switch" class="btn bg-emerald-600 hover:bg-emerald-500 text-white flex-1">
                                ...
                                ${t('artsmoker.ui.image_studio.generate_with').replace('{{model}}', suggestedLabel)}
                            </button>` : ''}
                            <button id="precheck-rewrite" class="btn bg-amber-600 hover:bg-amber-500 text-white">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                </svg>
                                ${t('artsmoker.ui.image_studio.rewrite_for').replace('{{model}}', currentLabel)}
                            </button>
                            <button id="precheck-proceed" class="btn btn-secondary">
                                ${t('artsmoker.ui.image_studio.try_anyway').replace('{{model}}', currentLabel)}
                            </button>
                            <button id="precheck-cancel" class="btn btn-secondary btn-sm">
                                ${t('artsmoker.ui.common.cancel')}
                            </button>
                        </div>
                    </div>
                </div>
            ...
            document.getElementById('precheck-rewrite')?.addEventListener('click', async () => {
                ...
                if (content) {
                    ...
                    content.innerHTML = html`<div class="flex flex-col items-center justify-center py-8 gap-3 text-brand-text-muted">
                        <div class="loading-spinner w-5 h-5 border-2 border-brand-accent/20 border-t-brand-accent rounded-full"></div>
                        <p>${t('artsmoker.ui.image_studio.attempting_rewrite').replace('{{model}}', currentLabel)}</p>
                        <p class="text-[10px] text-brand-text-muted/50">${t('artsmoker.ui.image_studio.canary_hint')}</p>
                    </div>`;
                }
                try {
                    ...
                    if (rewriteResult.rewritten_prompt) {
                        ...
                        if (content) {
                            ...
                            content.innerHTML = html`<div class="space-y-4">
                                <div>
                                    <h3 class="text-xs font-semibold text-emerald-400 uppercase tracking-wider mb-2 flex items-center gap-2">
                                        ${t('artsmoker.ui.image_studio.rewritten_prompt')} ${verifiedBadge}
                                    </h3>
                                    <textarea id="precheck-rewritten-text" class="input w-full min-h-[100px] text-sm">${rewriteResult.rewritten_prompt}</textarea>
                                </div>
                                <div class="p-3 rounded-lg bg-amber-950/20 border border-amber-500/20">
                                    <p class="text-[10px] text-amber-300/80"><strong>${t('artsmoker.ui.image_studio.best_effort_rewrite')}</strong> ${t('artsmoker.ui.image_studio.rewrite_not_guaranteed').replace('{{model}}', currentLabel)}</p>
                                </div>
                                <details class="text-xs">
                                    <summary class="text-brand-text-muted cursor-pointer hover:text-brand-text">${t('artsmoker.ui.image_studio.view_original_prompt')}</summary>
                                    <p class="mt-2 p-3 rounded-lg bg-brand-bg/60 whitespace-pre-wrap text-brand-text-muted">${originalPrompt}</p>
                                ...
                                <div class="flex gap-3 pt-2">
                                    <button id="precheck-accept-rewrite" class="btn btn-primary flex-1">
                                        ...
                                        ${t('artsmoker.ui.image_studio.use_rewrite_review')}
                                    </button>
                                    <button class="mod-close-btn btn btn-secondary">${t('artsmoker.ui.common.cancel')}</button>
                                </div>
                            </div>`;
                        ...
                        if (content) {
                            const explanation = rewriteResult.explanation || t('artsmoker.ui.image_studio.rewrite_unavailable');
                            // nosemgrep
                            content.innerHTML = html`<div class="p-4 text-center space-y-3">
                                <p class="text-sm text-red-300">${explanation}</p>
                                <p class="text-xs text-brand-text-muted">${t('artsmoker.ui.image_studio.retry_hint')}</p>
                                <button class="mod-close-btn btn btn-secondary">${t('artsmoker.ui.common.close')}</button>
                            </div>`;
                            content.querySelector('.mod-close-btn')?.addEventListener('click', () => dialog.remove());
                        }
                    }
        ...
        _setGenerating(on, total, payload) {
            ...
            if (on) {
                btn.disabled = true;
                // nosemgrep
                btn.innerHTML = html`<span class="spinner-sm"></span> ${t('artsmoker.ui.image_studio.generating')}`;
        ...
        _startProgress(total, payload) {
            ...
            if (text) text.textContent = t('artsmoker.ui.image_studio.starting');
            if (sub) sub.textContent = t('artsmoker.ui.image_studio.images_queued').replace('{{count}}', total).replace('{{plural}}', total > 1 ? 's' : '');
            ...
            const tick = setInterval(() => {
                ...
                const sec = secs % 60;
                if (elapsedEl) elapsedEl.textContent = min > 0 ? t('artsmoker.ui.image_studio.elapsed_min').replace('{{min}}', min).replace('{{sec}}', sec) : t('artsmoker.ui.image_studio.elapsed_sec').replace('{{sec}}', sec);
            }, 1000);
        ...
        _handleProgressEvent(evt, total) {
            ...
            switch (evt.type) {
                case 'started':
                    if (text) text.textContent = t('artsmoker.ui.image_studio.starting_generation');
                ...
                case 'stage':
                    ...
                    if (evt.stage === 'prompts') {
                        if (sub) sub.textContent = t('artsmoker.ui.image_studio.creating_concepts');
                        if (bar) bar.style.width = '10%';
                    } else if (evt.stage === 'generating') {
                        if (sub) sub.textContent = t('artsmoker.ui.image_studio.concepts_ready').replace('{{count}}', evt.prompts_done || '').replace('{{plural}}', (evt.prompts_done || 0) > 1 ? 's' : '');
                        if (bar) bar.style.width = '20%';
                    } else if (evt.stage === 'finalizing') {
                        if (sub) sub.textContent = t('artsmoker.ui.image_studio.saving_assets');
                ...
                case 'llm_status': {
                    ...
                    if (evt.state === 'retrying') {
                        if (text) text.textContent = t('artsmoker.ui.image_studio.llm_retrying')
                ...
                case 'image_done': {
                    ...
                    if (text) text.textContent = t('artsmoker.ui.image_studio.generating_images').replace('{{done}}', done).replace('{{total}}', tot);
                    if (sub) sub.textContent = t('artsmoker.ui.image_studio.option_variation_complete').replace('{{opt}}', (evt.option || 0) + 1).replace('{{var}}', (evt.variation || 0) + 1);
                ...
                case 'async_submitted': {
                    ...
                    const tot = evt.total || total;
                    const pct = 20 + Math.round((done / tot) * 70);
                    if (text) text.textContent = t('artsmoker.ui.custom_models.async_submitted').replace('{{model}}', evt.model_label);
                    if (sub) sub.textContent = t('artsmoker.ui.custom_models.async_submitted_hint');
                    if (bar) bar.style.width = Math.min(pct, 92) + '%';
                    ...
                    if (pendBtn) {
                        ...
                        if (pendLabel) {
                            ...
                            pendLabel.textContent = t('artsmoker.ui.custom_models.pending_jobs_count').replace('{{count}}', remaining);
                        }
                    }
                ...
                case 'image_error': {
                    const done = evt.completed || 0;
                    const tot = evt.total || total;
                    if (sub) sub.textContent = t('artsmoker.ui.image_studio.option_variation_failed').replace('{{opt}}', (evt.option || 0) + 1).replace('{{var}}', (evt.variation || 0) + 1);
                    break;
                }

                case 'throttled': {
                    if (text) text.textContent = t('artsmoker.ui.image_studio.api_throttled');
                    if (sub) sub.textContent = t('artsmoker.ui.image_studio.option_variation_waiting').replace('{{opt}}', (evt.option || 0) + 1).replace('{{var}}', (evt.variation || 0) + 1).replace('{{delay}}', evt.delay || '?');
                    break;
                }

                case 'retry': {
                    if (text) text.textContent = t('artsmoker.ui.image_studio.retrying').replace('{{attempt}}', evt.attempt || '?').replace('{{max}}', evt.max_retries || '?');
                    if (sub) sub.textContent = `${t('artsmoker.ui.image_studio.option')} ${(evt.option || 0) + 1}, ${t('artsmoker.ui.image_studio.variation')} ${(evt.variation || 0) + 1}`;
                    break;
                }

                case 'canary':
                    if (text) text.textContent = evt.message || t('artsmoker.ui.image_studio.testing_prompt');
                    if (sub) sub.textContent = t('artsmoker.ui.image_studio.verifying_moderation');
                    if (bar) bar.style.width = '15%';
                    break;

                case 'moderation_blocked':
                    if (text) text.textContent = t('artsmoker.ui.image_studio.moderation_blocked');
                ...
                case 'prompt_refused':
                    if (text) text.textContent = t('artsmoker.ui.image_studio.prompt_cannot_process');
                    if (sub) sub.textContent = evt.message || t('artsmoker.ui.image_studio.prompt_declined');
                    if (bar) bar.style.width = '100%';
                    break;

                case 'complete':
                    if (bar) bar.style.width = '100%';
                    if (text) text.textContent = t('artsmoker.ui.image_studio.done');
                    break;
            }
        },
        ...
        _renderResults(result) {
            ...
            if (labelEl) labelEl.textContent = t('artsmoker.ui.image_studio.post_processing');
                ...
                if (placeholder) {
                    ...
                    placeholder.innerHTML = html`
                        <div class="flex flex-col items-center justify-center gap-3 py-12 text-cyan-400/60">
                            ...
                            <span class="text-sm font-medium">${t('artsmoker.ui.image_studio.generating_with').replace('{{model}}', variant.model_label || t('artsmoker.ui.image_studio.custom_model_fallback'))}</span>
                            <span class="text-[10px] text-brand-text-muted/50">${t('artsmoker.ui.image_studio.image_when_ready')}</span>
                        </div>`;
                }
        ...
        async loadBatch(batchId) {
            window.showLoading?.(t('artsmoker.ui.image_studio.loading_batch'));
            ...
            try {
                ...
                if (deletedCount > 0 && originalTotal > 0) {
                    window.showToast?.(
                        t('artsmoker.ui.image_studio.batch_loaded_partial').replace('{{surviving}}', surviving).replace('{{total}}', originalTotal).replace('{{deleted}}', deletedCount),
                        'info', 6000
                    );
                } else {
                    window.showToast?.(
                        t('artsmoker.ui.image_studio.batch_loaded').replace('{{options}}', result.num_options).replace('{{variations}}', result.num_variations),
                        'success'
                    );
                }
            } catch (err) {
        ...
        _syncModelCheckboxes() {
            ...
            if (label) {
                if (this._selectedModels.length === 0) {
                    label.textContent = t('artsmoker.ui.image_studio.select_models') || 'Select models...';
                    ...
                    label.textContent = `${t('artsmoker.ui.image_studio.all_models') || 'All'} (${realModels.length} ${t('artsmoker.ui.image_studio.models_count') || 'models'})`;
                } else {
                    label.textContent = `${this._selectedModels.length} ${t('artsmoker.ui.image_studio.models_selected') || 'models selected'}`;
                }
            }
        ...
        _updateIpModelNote() {
            ...
            if ((ip.ip_owned || ip.ip_licensed) && strictModels.includes(model)) {
                ...
                // nosemgrep
                note.innerHTML = html`
                    ${raw(t('artsmoker.ui.image_studio.ip_strict_model_warning').replace('{{model}}', '<strong>' + escapeHtml(modelLabel) + '</strong>'))}
                    <button id="gen-ip-switch-model" class="underline text-amber-200 hover:text-amber-100 ml-1">${t('artsmoker.ui.image_studio.ip_switch_now')}</button>
                `;
                ...
                setTimeout(() => {
                    document.getElementById('gen-ip-switch-model')?.addEventListener('click', () => {
                        ...
                        this._syncModelCheckboxes();
                        this._updateIpModelNote();
                        window.showToast?.(t('artsmoker.ui.image_studio.switched_to'), 'success');
                    });
                }, 0);
            } else {
        ...
        _showCostBreakdown(totalCost, breakdown) {
            ...
            const labels = {
                'llm': t('artsmoker.ui.image_studio.cost_llm'),
                'image_generation': t('artsmoker.ui.image_studio.cost_image_generation'),
                'image_inpainting': t('artsmoker.ui.image_studio.cost_image_inpainting'),
                'image_outpainting': t('artsmoker.ui.image_studio.cost_image_outpainting'),
                'image_erase': t('artsmoker.ui.image_studio.cost_image_erase'),
                'image_remove_background': t('artsmoker.ui.image_studio.cost_image_remove_bg'),
                'image_upscale_creative': t('artsmoker.ui.image_studio.cost_image_upscale'),
                'image_search_replace': t('artsmoker.ui.image_studio.cost_image_search_replace'),
            };
            ...
            try {
                ...
                if (btn) {
                    ...
                    if (label) label.textContent = count > 0
                        ? t('artsmoker.ui.custom_models.pending_jobs_count').replace('{{count}}', count)
                        : t('artsmoker.ui.custom_models.completed_jobs_total').replace('{{count}}', jobs.length);
                }
                ...
                jobs.filter(j => j.status === 'complete' && !this._notifiedJobIds.has(j.job_id)).forEach(j => {
                    window.showToast?.(t('artsmoker.ui.custom_models.async_ready_toast').replace('{{model}}', j.model_label), 'success');
        ...
        async _showPendingJobs() {
            ...
            const jobsHtml = jobs.length === 0
                ? html`<p class="text-xs text-brand-text-muted py-4 text-center">${t('artsmoker.ui.custom_models.async_no_jobs')}</p>`
                : jobs.map(j => {
                ...
                <div class="bg-brand-surface rounded-xl border border-brand-border shadow-2xl max-w-lg w-full max-h-[70vh] flex flex-col overflow-hidden">
                    <div class="flex items-center justify-between px-5 py-3 border-b border-brand-border">
                        <h3 class="text-sm font-semibold text-brand-text flex items-center gap-2">
                            ...
                            ${t('artsmoker.ui.custom_models.pending_jobs')}
                        </h3>
                        <div class="flex gap-2">
                            ${jobs.some(j => j.status === 'complete' || j.status === 'failed') ? html`<button class="pj-clear text-[10px] text-brand-text-muted hover:text-red-400">${t('artsmoker.ui.custom_models.async_clear_completed')}</button>` : ''}
                    ...
                    <div class="px-4 py-2 text-[10px] text-brand-text-muted/70 border-b border-brand-border bg-brand-bg/30">
                        ${t('artsmoker.ui.custom_models.async_footer')}
                    </div>
