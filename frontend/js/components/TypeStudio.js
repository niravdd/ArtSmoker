                ...
                <div id="type-studio-view" class="view-enter">
                    ...
                    <div class="flex flex-col lg:flex-row gap-6">
                        ...
                        <aside class="lg:w-72 xl:w-80 flex-shrink-0 space-y-5">
                            ...
                            <button id="ts-model-settings-btn" class="w-full text-left p-3 rounded-lg bg-gradient-to-r from-brand-accent/15 to-brand-accent/5 border border-brand-accent/40 hover:border-brand-accent/70 hover:from-brand-accent/25 hover:to-brand-accent/10 transition-all flex items-center gap-2 text-xs text-brand-accent font-medium shadow-sm shadow-brand-accent/10 mt-3">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
