                ...
                <div id="video-studio-view" class="view-enter">
                    ...
                    <div class="flex flex-col lg:flex-row gap-6">
                        ...
                        <aside class="lg:w-72 xl:w-80 flex-shrink-0 space-y-5">
                            ...
                            <!-- Settings buttons -->
                            <button id="vs-model-settings-btn" class="w-full text-left p-3 rounded-lg bg-brand-accent/5 border border-brand-accent/20 hover:border-brand-accent/50 hover:bg-brand-accent/10 transition-colors flex items-center gap-2 text-xs text-brand-accent/80 hover:text-brand-accent">
